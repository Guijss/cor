...
const WheelSplit = ({ col, displaySize, maskCol }) => {
  return (
    <Wheel
      style={{
    ...
    hsla(${(col.hsb.h + 150) % 360}, 100%, 40%, 1) ${16 + 30 * 4}deg,
    hsla(${(col.hsb.h + 150) % 360}, 100%, 40%, 1) ${15 + 30 * 5}deg,
    hsla(${(col.hsb.h + 180) % 360}, 100%, 40%, 1) ${16 + 30 * 5}deg,
    hsla(${(col.hsb.h + 180) % 360}, 100%, 40%, 1) ${15 + 30 * 6}deg,
    hsla(${(col.hsb.h + 210) % 360}, 100%, 40%, 1) ${16 + 30 * 6}deg,
    hsla(${(col.hsb.h + 210) % 360}, 100%, 40%, 1) ${15 + 30 * 7}deg,
