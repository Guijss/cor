...
const WheelTriad = ({ col, displaySize, maskCol }) => {
  return (
    <Wheel
      style={{
    ...
    hsla(${(col.hsb.h + 120) % 360}, 100%, 40%, 1) ${16 + 30 * 3}deg,
    hsla(${(col.hsb.h + 120) % 360}, 100%, 40%, 1) ${15 + 30 * 4}deg,
    ...
    hsla(${(col.hsb.h + 240) % 360}, 100%, 40%, 1) ${16 + 30 * 7}deg,
    hsla(${(col.hsb.h + 240) % 360}, 100%, 40%, 1) ${15 + 30 * 8}deg,
