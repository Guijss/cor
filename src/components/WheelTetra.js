...
const WheelTetra = ({ col, displaySize, maskCol }) => {
  return (
    <Wheel
      style={{
    ...
    hsla(${(col.hsb.h + 30) % 360}, 100%, 40%, 0.2) 16deg,
    hsla(${(col.hsb.h + 30) % 360}, 100%, 40%, 0.2) ${15 + 30}deg,
    hsla(${(col.hsb.h + 60) % 360}, 100%, 40%, 0.2) ${16 + 30}deg,
    hsla(${(col.hsb.h + 60) % 360}, 100%, 40%, 0.2) ${15 + 30 * 2}deg,
    hsla(${(col.hsb.h + 90) % 360}, 100%, 40%, 1) ${16 + 30 * 2}deg,
    hsla(${(col.hsb.h + 90) % 360}, 100%, 40%, 1) ${15 + 30 * 3}deg,
    ...
    hsla(${(col.hsb.h + 180) % 360}, 100%, 40%, 1) ${16 + 30 * 5}deg,
    hsla(${(col.hsb.h + 180) % 360}, 100%, 40%, 1) ${15 + 30 * 6}deg,
    ...
    hsla(${(col.hsb.h + 270) % 360}, 100%, 40%, 1) ${16 + 30 * 8}deg,
    hsla(${(col.hsb.h + 270) % 360}, 100%, 40%, 1) ${15 + 30 * 9}deg,
    hsla(${(col.hsb.h + 300) % 360}, 100%, 40%, 0.2) ${16 + 30 * 9}deg,
    hsla(${(col.hsb.h + 300) % 360}, 100%, 40%, 0.2) ${15 + 30 * 10}deg,
    hsla(${(col.hsb.h + 330) % 360}, 100%, 40%, 0.2) ${16 + 30 * 10}deg,
    hsla(${(col.hsb.h + 330) % 360}, 100%, 40%, 0.2) ${15 + 30 * 11}deg,
